...
import profileCard from '@/components/Client/Shelter/shelter_Myshelter_ProfileCard.vue';
import detailCard from '@/components/Client/Shelter/shelter_Myshelter_DetailsCard.vue';
...
import popupNewpost from '@/components/Client/Shelter/shelter_NewPostModal.vue';
