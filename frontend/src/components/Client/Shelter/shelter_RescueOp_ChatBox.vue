            ...
            <div class="py-4">
                ...
                <div class="overflow-y-auto h-screen">
                    <div v-for="(conversation, index) in conversations" :key="index"
                        ...
                        <div class="border-t p-2 px-4 cursor-pointer hover:bg-gray-50" :class="{
                            'bg-gray-100':
                            ...
                            <div class="flex justify-between">
                                <span class="font-medium truncate">{{
                                    conversation[0].to === "me"
                                        ? conversation[0].from
                                        : conversation[0].to
                                }}</span>
                                <span class="text-[12px] sm:hidden xl:flex">{{
                                    getLastMessage(conversation).timestamp
                                }}</span>
                            </div>
                            <p class="text-sm truncate">
                                {{ getLastMessage(conversation).message }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div v-for="(message, messageIndex) in sortedMessages" :key="messageIndex">
                    <div v-if="message.from !== 'me'" class="flex text-sm text-gray-600 p-3 justify-start">
                        ...
                        <div>
                            <span v-if="
                                messageIndex === 0 ||
                                message.from !== sortedMessages[messageIndex - 1].from
        ...
        return {
            inboxs: [
                ...
                },
                {
                    ...
                    to: "me",
                    message:
                        "yeh? why you have a problem? dfdf dsad dsadsdas ds ds dasdsadas dsdsa dsdsdsa gdsagk gdsiaugd shdsah ku dsahdgu gdusagug g dusadgu dsadsad sa",
                    timestamp: "2022-01-01 10:05:14",
                },
                {
                    id: 5,
                    from: "me",
                ...
                },
                {
                    ...
                    to: "User  4",
                    message:
                        "im 3 fsd fddsfd fdfds fd fsdf dsfdfs dfd f d fd fd fd fd fd fd fdfdsf dfdsf df d fsdf sf",
                    timestamp: "2022-01-01 10:04:10",
                },
                {
                    id: 5,
