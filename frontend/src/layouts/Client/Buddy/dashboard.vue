          ...
          <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <Menu as="div" class="relative">
              <MenuButton class="-m-1.5 flex items-center p-1.5">
                ...
                <img class="h-8 w-8 rounded-full bg-gray-50" :src="avatar.profileImage" alt="profile-avatar" />
                <span class="hidden lg:flex lg:items-center">
                  <span class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">
                    {{ avatar.username }}
                  </span>
                  <component :is="avatar.icon" class="ml-2 h-5 w-5 text-gray-400" aria-hidden="true" />
                </span>
              </MenuButton>
...
import CreateReportModal from '@/components/Client/Buddy/buddy_CreateReportPost_Modal.vue'
const openCreateModal = ref(false) // for create report modal

const navigation = [
  { name: 'Home', to: { name: '' }, icon: HomeIcon, current: false },
  { name: 'Message', to: { name: 'Messages' }, icon: ChatBubbleOvalLeftEllipsisIcon, current: false },
